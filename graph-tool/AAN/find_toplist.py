...
with open("results/progeny_AAN.csv", "w+") as csv:
    csv.write("gt_index,rank,title,authors,date,indegree,indegree_rank,g-rank,g2-rank,fellow\n")
    i = 0
    count = 0
    ...
    #for v_i in top_g2[:20]:
        ...
        line = str(v_i) + "," + str(i) + "," + title + "," + auths + "," + dates[v] + "," + str(indeg) + "," + str(indeg_rank) + "," + str(g_rank) + "," + str(g2_rank) + "," + f + "\n"
        csv.write(line)
